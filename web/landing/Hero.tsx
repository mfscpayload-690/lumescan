...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 lg:pt-20 lg:pb-20 overflow-hidden">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 reveal reveal-up reveal-delay-5 opacity-40 hover:opacity-100 transition-opacity cursor-pointer hidden lg:flex"
